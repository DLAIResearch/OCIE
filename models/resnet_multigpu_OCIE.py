...
from .utils import compute_gradcam_mask,compute_Layercam
...
class ResNet(nn.Module):
    ...
    def forward(self, images, engry_criterion=None, xe_images=None,aug_images=None,pred=None,  targets=None,
        ...
        orig_gradcam_mask = compute_Layercam(images_outputs, images_feats, target1, self.relu)
        aug_gradcam_mask = compute_Layercam(aug_images_outputs, aug_images_feats, target2, self.relu)
