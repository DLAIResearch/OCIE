...
parser.add_argument('--log_dir', default='logs-imagenet-50-0.01-0_layercam', type=str, metavar='LG_PATH',
...
def train(train_loader, model, engry_criterion, xent_criterion,align_loss, optimizer, epoch, args, logger):
    ...
    for i in range(train_len):
        xe_images,aug_images, images, targets,pred= train_iter.__next__()
...
def save_checkpoint(state, is_best, save_dir):
    ...
    if is_best:
        best_filename = 'model_best.pth_imagenet.tar'
