...
parser.add_argument('-data', metavar='DIR',default='env/car/', help='path to dataset')
...
parser.add_argument('--resume',default='env/ocie2/model_best.pth_50-0.01_0.01-cars.tar',  type=str, metavar='PATH',
