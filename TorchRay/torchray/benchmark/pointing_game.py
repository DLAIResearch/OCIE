...
class PointingGameBenchmark(PointingGame):
    """Pointing game benchmark on standard dataset.
    ...
    def __init__(self, dataset, tolerance=15, difficult=False):
        ...
        if difficult:
            ...
            if isinstance(self.dataset, ds.VOCDetection):
                ...
                assert False, 'Difficult set is supported only for VOC and COCO dataset respectively.'
    ...
    def evaluate(self, label, class_id, point):
        ...
        if self.difficult:
            if isinstance(self.dataset, ds.VOCDetection):
                ...
                assert False, 'Only VOC and COCO dataset are supported for the difficult subset'
