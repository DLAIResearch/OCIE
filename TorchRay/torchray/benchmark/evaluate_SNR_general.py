...
parser.add_argument('-data', default='env/car/',metavar='DIR', help='path to dataset')
...
parser.add_argument('--resume', default='env/ocie2/model_best.pth-OUR_CAR_18_0.01_0.tar', type=str, metavar='PATH',
...
parser.add_argument('--dataset', type=str, default='cars',
                            help='dataset to use: [imagenet, cub, cars]')
